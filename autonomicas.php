...
$xml=simplexml_load_file('http://resultados.elpais.com/elecciones/'.$year.'/'.$tipo.'/'.$comunidad.'/index.xml2') or die("Error: Cannot create object");
  ...
  <body>      
    ...
    <div class="row">
      <div class="medium-12 columns">
          <h1>Elecciones Autonómicas</h1>
          <h2>Resultados del <?echo $year;?> en la comunidad de <?echo $xml->nombre_sitio;?></h2>
